...
# チェーンの合成：summary_chainの出力を"summary"キーでtranslate_chainに渡す
# データの流れ：{"text": "..."} → summary_chain実行 → {"summary": 要約} → translate_chain実行
composed_chain = {"summary": summary_chain} | translate_chain

text = """今日は来年度出力商品の新プロジェクト打ち合わせがありました。開発期間6ヵ月でチーム全員参加し詳細計画を策定しました。
マーケティング部から顧客ニーズ、技術部から実装可能性の報告あり、来週までに作業項目整理し次回進捗確認予定。"""
